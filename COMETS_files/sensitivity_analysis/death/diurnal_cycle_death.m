...
death_rates = [0.01, 0.05, 0.1, 0.15, 0.2, 0.3];
folders = cell(1,6);
for i=1:6
    ...
    folder_i = [folder '\' sprintf('N%d', AmmoniumConc) '_' sprintf('light_%0.2f', lightFlux) '_' sprintf('glycVmax_%0.2f', glycVmax) '_' sprintf('glycKm_%0.0e', glycKm) '_' sprintf('HCO3MAX_%0.0f', HCO3MAX) '_' sprintf('death_%0.2f', death_rate)];
